\begin{multicols}{2}
	Ye that stand in the \textbf{house} of \textbf{the} Lord * in the courts of \textbf{the} house of our God.
	...
	He smote the \textbf{first}born of \textbf{E}gypt * \gresetinitiallines{0}\gabcsnippet{(c4) both(j) man(i) and(h) beast.(g)}\gresetinitiallines{1}
	...
	They have ears, and \textbf{yet} they hear not * neither is there \textbf{a}ny breath in their mouths.
	
	They that make them are \textbf{like} un\textbf{to} them * and so are all they \textbf{that} put their trust in them.
	
	Praise the Lord, ye \textbf{house} of Is\textbf{ra}el * praise the Lord, \textbf{ye} house of Aaron.
