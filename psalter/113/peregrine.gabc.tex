...
The(hi) have(h) hands,(h) and(h) han(h)dle(h) not(h) (,) feet(h) have(h) they,(h) and(h) walk(g) not(f) <sp>*</sp>(:) nei(gv)ther(gv) speak(f) they(d) through(fv) their(fv) throat.(ed) (::)
