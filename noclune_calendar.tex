\vechapter{Liturgical Calendar}
	...
	\vesectionp{December}
		\begin{enumerate}[noitemsep, nolistsep]
			...
			\item Of the Octave. \red{9 lect. triplex}
		\end{enumerate}
	\vesectionp{January}
		\begin{enumerate}[noitemsep, nolistsep]
			...
			\item \textcolor{purple}{Eve of the Epiphany.} \red{9 lect. triplex.}
			\item \red{\textbf{Epiphany of the Lord.}} Solemnity.\footnote{On the following days, until the Sunday after Epiphany, its office is repeated.}
		\end{enumerate}