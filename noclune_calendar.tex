\vechapter{Liturgical Calendar}
	...
	\vesectionp{January}
		\begin{enumerate}[noitemsep, nolistsep]
			...
			\item Of the Octave of the Epiphany.
			\item Of the Octave of the Epiphany.
			\item Of the Octave of the Epiphany.\footnote{If the octave falls on a Sunday, it is transferred to the preceding day.}
			\item Octave of the Epiphany. \red{9 lext. triplex}
		\end{enumerate}