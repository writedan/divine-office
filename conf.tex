...
\newcommand{\vechapter}[1]{%
	...
	\fancyhead[CO,CE]{\textbf{\vetempmacrolol}}%
}%
\makeatother

\newcommand{\vesectionp}[1]{%
	\skiplines{1}
	\StrSubstitute{#1}{\\}{\space}[\veforthesection]%
	\fancyhead[CE]{\textbf{\veforthesection}}%
	\begin{center}
		\setstretch{1.5}
...
\newcommand{\vesection}[1]{%
	\clearpage\thispagestyle{plain}\skiplines{-2}\vesectionp{#1}%
}%
\makeatother
