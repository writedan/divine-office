...
\vesectionp{Psalmody and Propers}
	...
	\instruct{If there is a responsory, the lector still before the altar will intone it from the capitulary and sing the verses; otherwise he here returns to his place. Once the responsory is completed he returns to his place.}
...
\vesectionp{Conclusion}\label{vespers:conclusion}
	...
	\instruct{All then kneel as the cantors turn back to the \blueribbon and sing the kyrie as there appointed. The minister should incense the whole church and congregation while it is sung, proceeding from down the north, up the nave, down the south, and up the nave again.}
