\vesectionp{Introduction}\label{vespers:introduction}
	...
	\skiplines{1}\gabcsnippet{(c3) <sp>v</sp> O(f) God,(hv) <sp>+</sp> make(h) speed(iv) to(h) save(g) me.(hv) <sp>r</sp>(::) O(hv) Lord,(h) make(h) haste(h) to(h) help(g) me.(hv)}
...
\vesectionp{Psalmody and Propers}
	...
	\instruct{If there is a responsory, the lector will intone it from the capitulary and sing the verses..}
	
	\instruct{Turn to the \blueribbon and sing the responsory, if appointed, along with the hymn, versicle, and Magnificat there appointed until turning back here.}
