...
\vesectionp{Preces}\label{vespers:preces}
	...
	\instruct{The preces are said on feria when no feast occurs, but they are omitted from December 17 until after the Epiphany. If the preces are not to be said, skip to the conclusion on pp. \pageref{vespers:conclusion}.}
