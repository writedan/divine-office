...
\greannotation{\veformat{viii. ii.}}
\skiplines{1}\gabcsnippet{
	(c3) Bles(e)sed(f) (:?) are(hr) all() they() that(h) <b>fear</b>(i) the(hr) Lord(h) <sp>*</sp>(:) and(hr) <b>walk</b>(f) in(h) his(i) ways.(hr h)
}
...
\skiplines{1}\gabcsnippet{
	(c4) Lord,(h) I(g) (:?) am(hr h) <b>not</b>(g) high(h) mind(i)ded(hr h) <sp>*</sp>(:) I(hr) have() no(h) proud(g) looks.(h)
}
