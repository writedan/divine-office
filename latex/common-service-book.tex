...
\begin{luacode*}
	-- First define how modules are loaded
	package.preload['divine_office'] = function()
	...
	if not divine_latex then
	error("failed to load divine office module")
	end
	
	-- Define the function to be called from LaTeX
