...
\skiplines{-0.5}\gregorioscore{hymn/lucis_creator_optime/1.gabc}
...
\gresetinitiallines{0}
\skiplines{0.75}\gregorioscore{hymn/lucis_creator_optime/2.gabc}
\skiplines{\vehymn}\begin{nstabbing}
...
\skiplines{0.75}\gregorioscore{hymn/lucis_creator_optime/3.gabc}
\skiplines{\vehymn}\begin{nstabbing}
...
\skiplines{0.75}\gregorioscore{hymn/lucis_creator_optime/4.gabc}
\skiplines{\vehymn}\begin{nstabbing}
