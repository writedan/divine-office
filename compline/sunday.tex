...
\skiplines{1}\input{hymn/te_lucis_ante_terminum_solemn}
...
\instruct{Turn to the \whiteribbon at the conclusion rite, pp. \pageref{compline:conclusion}.}\pagebreak[2]

\greannotation{\veformat{Anth.}}
\greannotation{\veformat{i.}}
\clearpage\skiplines{0}\gregorioscore{anthem/salve_regina_solemn.gabc}
...
\instruct{Turn to the \whiteribbon for the final prayers.}